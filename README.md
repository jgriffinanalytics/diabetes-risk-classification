...
- **The simpler model performed better.** Combining prediabetes and diabetes into one "at-risk" group gave up some detail but gained about 20 points of accuracy. For a broad screening tool that prioritizes accuracy, that is a worthwhile trade.
